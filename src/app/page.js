...
export default function Home() {
  ...
  <p>
    The app lets users log their dance activity, including:
...
<a href="https://tally.so/r/nrprJ5">
        <button className="px-6 py-3 rounded-2xl bg-purple-700 text-white font-semibold shadow-md hover:bg-purple-800 transition-all duration-200 hover:scale-105 hover:shadow-lg">
  Join the Waitlist
</button>
